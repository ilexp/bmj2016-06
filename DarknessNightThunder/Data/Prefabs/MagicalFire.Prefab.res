<root dataType="Struct" type="Duality.Resources.Prefab" id="129723834">
  ...
  <objTree dataType="Struct" type="Duality.GameObject" id="3575206765">
    <active dataType="Bool">true</active>
    <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="4037837646">
      <_items dataType="Array" type="Duality.GameObject[]" id="4211051216" length="4">
        <item dataType="Struct" type="Duality.GameObject" id="4275603994">
          <active dataType="Bool">true</active>
          <children />
          <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3679518930">
            <_items dataType="Array" type="Duality.Component[]" id="4250689360" length="4">
              <item dataType="Struct" type="Duality.Components.Transform" id="2340951630">
                <active dataType="Bool">true</active>
                ...
                <parentTransform dataType="Struct" type="Duality.Components.Transform" id="1640554401">
                  <active dataType="Bool">true</active>
                  <angle dataType="Float">0</angle>
                  <angleAbs dataType="Float">0</angleAbs>
                  <angleVel dataType="Float">0</angleVel>
          ...
          <compTransform dataType="ObjectRef">2340951630</compTransform>
          <identifier dataType="Struct" type="System.Guid" surrogate="true">
            <header>
              <data dataType="Array" type="System.Byte[]" id="1154202612">rMfQ/wgDPE2L6wJ+VLzlig==</data>
            </header>
            <body />
          </identifier>
          <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
          <name dataType="String">FireBallLightFar</name>
          <parent dataType="ObjectRef">3575206765</parent>
          <prefabLink />
        </item>
        <item dataType="Struct" type="Duality.GameObject" id="1010540099">
          <active dataType="Bool">true</active>
          <children />
          <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="527914135">
            <_items dataType="Array" type="Duality.Component[]" id="15645966" length="4">
              <item dataType="Struct" type="Duality.Components.Transform" id="3370855031">
                <active dataType="Bool">true</active>
                <angle dataType="Float">0</angle>
                <angleAbs dataType="Float">0</angleAbs>
                <angleVel dataType="Float">0</angleVel>
                ...
                <ignoreParent dataType="Bool">false</ignoreParent>
                <parentTransform dataType="ObjectRef">1640554401</parentTransform>
                <pos dataType="Struct" type="Duality.Vector3" />
                <posAbs dataType="Struct" type="Duality.Vector3">
                  <X dataType="Float">103</X>
                  <Y dataType="Float">137</Y>
          ...
          <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="318194368" surrogate="true">
            <header />
            <body>
              <keys dataType="Array" type="System.Object[]" id="1565282333">
          ...
          <compTransform dataType="ObjectRef">3370855031</compTransform>
          <identifier dataType="Struct" type="System.Guid" surrogate="true">
            <header>
              <data dataType="Array" type="System.Byte[]" id="3911109815">aNctzBYj/UmbStMttL0Y1g==</data>
            </header>
            <body />
          </identifier>
          <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
          <name dataType="String">FireBallLightNear</name>
          <parent dataType="ObjectRef">3575206765</parent>
          <prefabLink />
        </item>
      </_items>
    ...
    <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2279810634">
      <_items dataType="Array" type="Duality.Component[]" id="2164202508" length="8">
        <item dataType="ObjectRef">1640554401</item>
        <item dataType="Struct" type="DarknessNightThunder.MagicalObjects.MagicalFire" id="3470167048">
          <active dataType="Bool">true</active>
          <energy dataType="Float">100</energy>
          <fireLoopSound dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Sound]]">
        ...
        <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="2343015993">
          <active dataType="Bool">true</active>
          ...
          <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="1880743461">
            <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="1429503126">
              <item dataType="Struct" type="Duality.Components.Physics.CircleShapeInfo" id="3054133792">
        ...
        <item dataType="Struct" type="DarknessNightThunder.ActorRenderer" id="2763233498">
          <active dataType="Bool">true</active>
          <animDuration dataType="Float">0.66</animDuration>
          <animFirstFrame dataType="Int">0</animFirstFrame>
          ...
          <sharedMat dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Material]]">
            <contentPath dataType="String">Data\Sprites\FireBall.Material.res</contentPath>
          </sharedMat>
          <visibilityGroup dataType="Enum" type="Duality.Drawing.VisibilityFlag" name="Group0, Group1" value="3" />
        </item>
        <item dataType="Struct" type="DarknessNightThunder.SpellInteractor" id="647038143">
          <active dataType="Bool">true</active>
          <gameobj dataType="ObjectRef">3575206765</gameobj>
        </item>
      </_items>
    ...
    <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1988249342" surrogate="true">
      <header />
      <body>
        <keys dataType="Array" type="System.Object[]" id="1124386464">
          <item dataType="ObjectRef">3138994540</item>
        ...
        <values dataType="Array" type="System.Object[]" id="495047822">
          <item dataType="ObjectRef">1640554401</item>
          <item dataType="ObjectRef">3470167048</item>
          <item dataType="ObjectRef">2343015993</item>
          <item dataType="ObjectRef">2763233498</item>
          <item dataType="ObjectRef">647038143</item>
        </values>
      </body>
    </compMap>
    <compTransform dataType="ObjectRef">1640554401</compTransform>
    <identifier dataType="Struct" type="System.Guid" surrogate="true">
      <header>
        <data dataType="Array" type="System.Byte[]" id="3369529020">9RrHwd5YA0mlnEwb/F0/mw==</data>
      </header>
      <body />
    </identifier>
    <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
    <name dataType="String">MagicalFire</name>
    <parent />
    <prefabLink />
  </objTree>
</root>
